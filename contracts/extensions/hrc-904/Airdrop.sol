...
contract Airdrop is HederaTokenService {
  ...
  function tokenAirdrop(
    ...
    IHederaTokenService.TokenTransferList[]
      memory tokenTransfers = new IHederaTokenService.TokenTransferList[](1);
  ...
  function nftAirdrop(
    ...
    airdrop.token = token;
    IHederaTokenService.NftTransfer memory nftTransfer = prepareNftTransfer(
      sender,
      receiver,
      serial
    );
    IHederaTokenService.NftTransfer[]
      memory nftTransfers = new IHederaTokenService.NftTransfer[](1);
  ...
  function tokenAirdropDistribute(
    ...
    IHederaTokenService.AccountAmount[]
      memory transfers = new IHederaTokenService.AccountAmount[](length);
  ...
  function nftAirdropDistribute(
    ...
    airdrop.token = token;
    IHederaTokenService.NftTransfer[]
      memory nftTransfers = new IHederaTokenService.NftTransfer[](length);
  ...
  function mixedAirdrop(
    ...
    for (uint i = 0; i < tokenSenders.length; i++) {
      ...
      airdrop.transfers = createAccountTransferPair(
        tokenSenders[i],
        tokenReceivers[i],
        tokenAmount
      );
    ...
    for (uint v = 0; nftIndex < length; v++) {
      ...
      IHederaTokenService.NftTransfer[]
        memory nftTransfers = new IHederaTokenService.NftTransfer[](1);
      nftTransfers[0] = prepareNftTransfer(
        nftSenders[v],
        nftReceivers[v],
        serials[v]
      );
  ...
  function createAccountTransferPair(
    address sender,
    address receiver,
    int64 amount
  )
  ...
  function prepareNftTransfer(
    address sender,
    address receiver,
    int64 serial
  ) internal pure returns (IHederaTokenService.NftTransfer memory nftTransfer) {
